  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content1">
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath }/manager/backend/app/checksave" method="post">
          <input type="hidden" name="id" value="${appInfo.id}">
          <input type="hidden" name="vid" value="${appInfo.versionId}">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${appInfo.categoryLevel1Name} --> ${appInfo.categoryLevel2Name} --> ${appInfo.categoryLevel1Name}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
